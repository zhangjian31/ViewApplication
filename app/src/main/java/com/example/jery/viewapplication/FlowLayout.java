...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (lineWidth + childWidth > withSize - getPaddingLeft() - getPaddingRight()) {
                width = Math.max(width, lineWidth);//上一行的
                height += lineHeight;
        ...
        setMeasuredDimension(withMode == MeasureSpec.EXACTLY ? withSize : width + getPaddingLeft() + getPaddingRight(), heightMode == MeasureSpec.EXACTLY ? heightSize : height + getPaddingTop() + getPaddingBottom());
    }
